...
def main(FLAG, insert_min, insert_max, fformat, readlib, chr, infile, out_dir):
...
def ispaired_bydef(read):
    ...
    if (not read.is_reverse) and (not read.mate_is_reverse) and r3_pos < f3_pos and frag_len > insert_min and frag_len < insert_max:  # on '+' strand
        return True
    elif read.is_reverse and read.mate_is_reverse and f3_pos < r3_pos and frag_len > insert_min and frag_len < insert_max:  # on '-' strand
        return True
    else:
        return False
...
if __name__ == '__main__':
    ...
    parser.add_argument('--insert_min', type=int, default=0, help='the minimum insert size of mate-pair reads, default=0')
    parser.add_argument('--insert_max', type=int, default=15000, help='the maximum insert size of mate-pair reads, default=15000')
    ...
    if os.path.isdir(args.out_dir):
        ...
        sys.exit(2)
    main(args.flag, args.insert_min, args.insert_max, fformat, readlib, args.chr, infile, out_dir)
